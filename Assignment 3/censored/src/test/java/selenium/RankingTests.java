...
public class RankingTests extends AbstractSeleniumTest {
	...
	// â€œ0:rank-q diams, 1:rank-j clubs, 2:rank-4 spades, 3:rank-8 clubs,  4:rank-2 clubs");
	this.delay(1);
	//17a: missing code
    ...
    public void Rig3(){
    	...
    	// with â€œ0:rank-7 clubs,1:rank-j clubs,4:rank-5 diams"
    	//25: missing code
    	
    	
       	//Handle prompt to improve user 2
       	//with â€�0:rank-4 spades,1:rank-a clubs"
       	//26: missing code 
	...
	//user 1, user 2 hit and user 3 stays
    	...
    	// Player gets
	//â€œ0:rank-4 spades, 1:rank-7 clubs, 2:rank-a clubs,3:rank-q spades,4:rank-5 spades")
    	//28: missing code 
